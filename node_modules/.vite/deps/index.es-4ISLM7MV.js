...
var init_index_es = __esm({
  "node_modules/canvg/lib/index.es.js"() {
    import_es_promise = __toESM(require_es_promise());
    init_asyncToGenerator();
    import_es_string_match = __toESM(require_es_string_match());
    import_es_string_replace = __toESM(require_es_string_replace());
    import_es_string_starts_with = __toESM(require_es_string_starts_with());
    import_es_array_iterator = __toESM(require_es_array_iterator());
    import_web_dom_collections_iterator = __toESM(require_web_dom_collections_iterator());
    init_defineProperty();
    import_es_array_reduce = __toESM(require_es_array_reduce());
    import_es_string_ends_with = __toESM(require_es_string_ends_with());
    import_es_string_split = __toESM(require_es_string_split());
    import_raf = __toESM(require_raf());
    import_es_string_trim = __toESM(require_es_string_trim());
    import_rgbcolor = __toESM(require_rgbcolor());
    import_es_array_index_of = __toESM(require_es_array_index_of());
    import_es_string_includes = __toESM(require_es_string_includes());
    import_es_array_reverse = __toESM(require_es_array_reverse());
    init_SVGPathData_module();
    import_es_regexp_to_string = __toESM(require_es_regexp_to_string());
    init_stackblur_es();
    index = Object.freeze({
      __proto__: null,
      offscreen,
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-4ISLM7MV.js.map
