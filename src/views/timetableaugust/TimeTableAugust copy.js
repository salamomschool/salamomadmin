...
const AtTimeTable = () => {
  ...
  const [upgradeYear, setupgradeYear] = useState(localStorage.getItem('yearUpgradeAugust'))
  const [getT_grade, setgetT_grade] = useState('')
  const [khYear, setkhYear] = useState(localStorage.getItem('outlineKhYearAugust'))
  const [selectTimeTable, setselectTimeTable] = useState(localStorage.getItem('New_Time_Table_August') || 'default')
  const [selectTimeTableYear, setselectTimeTableYear] = useState(localStorage.getItem('New_Time_Table_Year_August') || 'default')
  ...
  useEffect(() => {
    ...
    const mainDb = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/` + `${selectTimeTable}`);
    const mainTimeTable = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/`);
    const mainDbSecondary = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/អនុវិទ្យាល័យ/`);
    const mainDbHigh = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/វិទ្យាល័យ/`);
    const enmainDbPrimary = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_english/បឋមសិក្សា/`);
    const enmainDbSecondary = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_english/អនុវិទ្យាល័យ/`);
    const enmainDbHigh = ref(db2, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_english/វិទ្យាល័យ/`);
    const mainDatabase = ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/${selectTimeTable}/`);
    onValue(mainDb, (data) => {
    ...
    onValue(mainDatabase, (data) => {
      data.forEach(d => {
        ...
        setTimeout(() => {
          ...
          if (tdElements1) {
            update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/${selectTimeTable}/` + name), {
              total_time1: count1,
            });
          }
          if (tdElements2) {
        ...
        if (t_type === 'english') {
          setTimeout(() => {
            ...
            if (EntdElements1) {
              update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_english/${selectTimeTable}/` + name), {
  ...
  useEffect(() => {
    ...
    if (selectTimeTable == 'បឋមសិក្សា') {
      onValue(dbPrimaryClass, (data) => {
        ...
        data.forEach(e => {
          ...
          update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/` + `${selectTimeTable}/` + id.replace(/\b0+/g, '')), {
            id: g_kh,
            clEn: id,
    ...
    const time1 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី១`);
    const time2 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី២`);
    const time3 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី៣`);
    const time4 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី៤`);
    const time5 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី៥`);
    const time6 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី៦`);
    // const time7 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី៧`);
    // const time8 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងទី៨`);
    const break1 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងចេញលេងទី១`);
    const break2 = ref(db, `/SalaMOM/tools/times_august/ម៉ោងចេញលេងទី២`);
  ...
  // Pickup the date
  const [pickupDate, setPickupDate] = useState(localStorage.getItem('setIssueAugust') || 'default');
  useEffect(() => {
    localStorage.setItem('setIssueAugust', pickupDate)
    setPickupDate(localStorage.getItem('setIssueAugust') || 'default')
  }, [pickupDate])
      ...
      if (id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            remove(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/${selectTimeTable}/` + id));
          }
        });
      }
    }
      ...
      if (id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            remove(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_english/${selectTimeTable}/` + id));
          }
        });
      }
    }
                          ...
                          <div id="myTable">
                            ...
                            <table className="table table-bordered" ref={tableRef}>
                              <thead>
                                ...
                                <tr>
                                  <td colspan="2">ចន្ទ័</td>
                                  <Count1 />

                                </tr>
                                <tr>
                                  <td>1</td>
                                  <td style={{ color: 'darkblue' }}>08:00-08:50</td>
                                  <Mon_mor_t1 />

                                </tr>
                                <tr>
                                  <td>2</td>
                                  <td style={{ color: 'darkblue' }}>09:10-10:00</td>
                                  <Mon_mor_t2 />

                                </tr>
                                <tr>
                                  <td>3</td>
                                  <td style={{ color: '#b325d6' }}>10:00-10:50</td>
                                  <Mon_mor_t3 />
                                ...
                                <tr>
                                  ...
                                  <td style={{ color: 'darkred' }}>02:45-03:35</td>
                                  <Mon_aft_t3 />
                                </tr>
                                <tr>
                                  <td colspan="2">អង្គារ</td>
                                  <Count2 />
                                </tr>
                                <tr>
                                  <td>1</td>
      ...
      <>
        {mainData.map((d, index) => (
          <tr>
            ...
            >
              <div className="cell-content">
                <span class="tr4" ref={user_sub} data-t={d.tname_mon_aft_t1}>{d.sub_mon_aft_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr5" ref={user_sub} data-t={d.tname_mon_aft_t2}>{d.sub_mon_aft_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr6" ref={user_sub} data-t={d.tname_mon_aft_t3}>{d.sub_mon_aft_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr7" ref={user_sub} data-t={d.tname_tue_mor_t1}>{d.sub_tue_mor_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr8" ref={user_sub} data-t={d.tname_tue_mor_t2}>{d.sub_tue_mor_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr9" ref={user_sub} data-t={d.tname_tue_mor_t3}>{d.sub_tue_mor_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr10" ref={user_sub} data-t={d.tname_tue_aft_t1}>{d.sub_tue_aft_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr11" ref={user_sub} data-t={d.tname_tue_aft_t2}>{d.sub_tue_aft_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr12" ref={user_sub} data-t={d.tname_tue_aft_t3}>{d.sub_tue_aft_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr13" ref={user_sub} data-t={d.tname_wed_mor_t1}>{d.sub_wed_mor_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr14" ref={user_sub} data-t={d.tname_wed_mor_t2}>{d.sub_wed_mor_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr15" ref={user_sub} data-t={d.tname_wed_mor_t3}>{d.sub_wed_mor_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr16" ref={user_sub} data-t={d.tname_wed_aft_t1}>{d.sub_wed_aft_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr17" ref={user_sub} data-t={d.tname_wed_aft_t2}>{d.sub_wed_aft_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr18" ref={user_sub} data-t={d.tname_wed_aft_t3}>{d.sub_wed_aft_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr19" ref={user_sub} data-t={d.tname_thu_mor_t1}>{d.sub_thu_mor_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr20" ref={user_sub} data-t={d.tname_thu_mor_t2}>{d.sub_thu_mor_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr21" ref={user_sub} data-t={d.tname_thu_mor_t3}>{d.sub_thu_mor_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr22" ref={user_sub} data-t={d.tname_thu_aft_t1}>{d.sub_thu_aft_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr23" ref={user_sub} data-t={d.tname_thu_aft_t2}>{d.sub_thu_aft_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr24" ref={user_sub} data-t={d.tname_thu_aft_t3}>{d.sub_thu_aft_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr25" ref={user_sub} data-t={d.tname_fri_mor_t1}>{d.sub_fri_mor_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr26" ref={user_sub} data-t={d.tname_fri_mor_t2}>{d.sub_fri_mor_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr27" ref={user_sub} data-t={d.tname_fri_mor_t3}>{d.sub_fri_mor_t3}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr28" ref={user_sub} data-t={d.tname_fri_aft_t1}>{d.sub_fri_aft_t1}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr29" ref={user_sub} data-t={d.tname_fri_aft_t2}>{d.sub_fri_aft_t2}</span>
                <img class="img-circle" onError={handleImageError}
            ...
            >
              <div className="cell-content">
                <span class="tr30" ref={user_sub} data-t={d.tname_fri_aft_t3}>{d.sub_fri_aft_t3}</span>
                <img class="img-circle" onError={handleImageError}
  ...
  const setTimeTableAugust = (e) => {
    ...
    if (data_cell === 'cell1') {
      if (data_row_1.includes(id)) {
        ...
        update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/${selectTimeTable}/` + grade), {
        ...
        update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/${selectTimeTable}/` + id), {
          grade_mon_mor_t1: grade,
          img_mon_mor_t1: imgUrl,
          sub_mon_mor_t1: subs,
          tname_mon_mor_t1: id,
        ...
        if (userType === 'no') {
          update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/អនុវិទ្យាល័យ/` + id), {
            grade_mon_mor_t1: grade,
            img_mon_mor_t1: imgUrl,
            sub_mon_mor_t1: subs,
            tname_mon_mor_t1: id,
        ...
        if (userType === 'ok') {
          update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_teacher/វិទ្យាល័យ/` + id), {
            grade_mon_mor_t1: grade,
            img_mon_mor_t1: imgUrl,
            sub_mon_mor_t1: subs,
            tname_mon_mor_t1: id,
      ...
      if (subs == 'E') {
        update(ref(db, `/SalaMOM/tools/timeTable_august/${selectTimeTableYear}/by_english/${selectTimeTable}/` + id), {
          grade_mon_mor_t1: grade,
          img_mon_mor_t1: imgUrl,
          sub_mon_mor_t1: subs,
          tname_mon_mor_t1: id,
      ...
      if (data_row_5.includes(id)) {
        ...
        if (userType === 'ok') {
          update(ref(db, `/SalaMOMtools/timeTable_august/${selectTimeTableYear}/by_teacher/វិទ្យាល័យ/` + id), {
            grade_mon_aft_t2: grade,
            img_mon_aft_t2: imgUrl,
            sub_mon_aft_t2: subs,
            tname_mon_aft_t2: id,
      ...
      if (subs == 'E') {
        update(ref(db, `/SalaMOMtools/timeTable_august/${selectTimeTableYear}/by_english/${selectTimeTable}/` + id), {
          grade_mon_aft_t2: grade,
          img_mon_aft_t2: imgUrl,
          sub_mon_aft_t2: subs,
          tname_mon_aft_t2: id,
      ...
      if (data_row_6.includes(id)) {
        ...
        update(ref(db, `/SalaMOMtools/timeTable_august/${selectTimeTableYear}/${selectTimeTable}/` + grade), {
        ...
        update(ref(db, `/SalaMOMtools/timeTable_august/${selectTimeTableYear}/by_teacher/${selectTimeTable}/` + id), {
          grade_mon_aft_t3: grade,
          img_mon_aft_t3: imgUrl,
          sub_mon_aft_t3: subs,
          tname_mon_aft_t3: id,
        ...
        if (userType === 'no') {
          update(ref(db, `/SalaMOMtools/timeTable_august/${selectTimeTableYear}/by_teacher/អនុវិទ្យាល័យ/` + id), {
            grade_mon_aft_t3: grade,
            img_mon_aft_t3: imgUrl,
            sub_mon_aft_t3: subs,
            tname_mon_aft_t3: id,
    ...
    newWindow.document.write(`
                  ...
                  <thead>
                      ...
                      <tr>
                          ...
                          <th></th>
                          <th class="text-center text_table pavachana">នាយិកាសាលា</th>
                      </tr>
                      <tr>
                          <th style="width:35vh;" class="text-center text_table">
                              </th>
      ...
      <>
        <select className="btn btn-success btn-sm text-center me-3"
          ...
          onChange={e => {
            ...
            localStorage.setItem('yearUpgradeAugust', e.target.value)
    ...
    const uploadData = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          update(ref(db, `/SalaMOM/tools/timeTable_august/${upgradeYear}/`), mainTimeTable);
        }
      });
    }
    const deleteData = () => {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          remove(ref(db, `/SalaMOM/tools/timeTable_august/${upgradeYear}/`));
  ...
  const GetDataYear = (e) => {
    ...
    localStorage.setItem('outlineKhYearAugust', getKhYear.dataset.khyear)
    window.location.reload()
  }
  ...
  useEffect(() => {
    localStorage.setItem('New_Time_Table_August', selectTimeTable)
    setselectTimeTable(localStorage.getItem('New_Time_Table_August') || 'default')
  }, [selectTimeTable])
  useEffect(() => {
    localStorage.setItem('New_Time_Table_Year_August', selectTimeTableYear)
    setselectTimeTableYear(localStorage.getItem('New_Time_Table_Year_August') || 'default')
  }, [selectTimeTableYear])
