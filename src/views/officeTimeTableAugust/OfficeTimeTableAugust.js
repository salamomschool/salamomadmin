...
const OfficeTimeTableAugust = () => {
  ...
  if (data_cell === 'cell7') {
    if (data_row_7.includes(user_id.current.value)) {
        ...
        <div className="card card-primary card-outline">
          <div className="card-body">
            <div className="text-center">
              <div className="row">
                <h4 className="card-title">កាលវិភាគបង្រៀនខែសីហាកម្រិត <span>{selectTimeTable}</span></h4>
...
export default OfficeTimeTableAugust
